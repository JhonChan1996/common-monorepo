  ...
  <div class="login-container">
    <div class="login-content">
      ...
      <div class="form">
        ...
        <a-form
          v-if="props.data?.loginType === 'passwordVerify'"
          ref="loginFormRef"
          :model="loginForm"
          class="login-form"
          auto-complete="on"
        ...
        >
          ...
          <a-row :gutter="16">
            ...
            <a-col>
              <a-button type="primary" @click="switchRegister">
                去注册
              </a-button>
            </a-col>
          </a-row>
...
const login = () => {
  loginFormRef.value
    .validate()
    .then(() => {
      console.log(props.data.loginApi, loginForm.value);
...
const switchRegister = () => {
  props.router.push(props.data.switchRegister);
  // emit('onRouteChange', props.data.switchRegister);
};
</script>
